                        ...
                        <div className="col-9">
                            <div className="settings">
                                <div style={{ marginTop: "11rem" }}>
                                    {store_link !== "" ?
                                        <a href={`${store_link.store_link}`} target='_blank' rel="noreferrer" className="btn mt-4 width_one btn-md" style={{ background: "linear-gradient(to right,#6561ba,#16168e)", border: "none", padding: ".6rem 1rem", color: "#fff" }}>
                                            <b>GET A STORE</b>
                                        </a>
                                    :
                                    ...
                                    {store_link !== "" &&
                                        <form onSubmit={onSetStoreLinkSubmit} className="mr-4 mt-4">
                                            <h6 className="pt-3 text-info">Already have a store link?</h6>
                                            <div className="form-row align-items-center">
                                                <div className="form-group col-md-5">
                                                    <label><b>Set Personal Store Link</b></label>
                                                    <input name="personal_store" onChange={onStoreLinkChange} type="text" className="form-control" style={{ height: "4rem" }} placeholder={`${user.personal_store}`} required />
                                                </div>
                                                <div className="form-group col-sm-12 col-md-2">
                                                    <button type="submit" className="btn mt-4 width_one btn-md" style={{ background: "linear-gradient(to right,#6561ba,#16168e)", border: "none", padding: ".6rem 1rem", color: "#fff" }}>
                                                        {user.persona_store === null ? <b>SET STORE</b> : <b>UPDATE STORE</b>}
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
