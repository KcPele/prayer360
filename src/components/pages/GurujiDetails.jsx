...
const GurujiDetails = () => {
  ...
  const { subscribeToGuruji, clearResponsState, requestResponse, userError } =
    userContext;
              ...
              <div className="contents">
                <div className="my-4">
                  <div className="earning none mb-5">
                    <h6>
                      Total Earning <b>${guruji.earning}</b>
                    </h6>
                  </div>
                  ...
                  <div className="row pl-4 center display_none">
                    <div className="col-md-3">
                      <h6 className="pb-2">
                        ...
                        <b className="pl-2">
                          {guruji.specialization !== null &&
                            guruji.specialization.length > 0 &&
                            guruji.specialization.map((spec) => ({ spec }))}
                        </b>
                      </h6>
                      <h6 className="pb-2">
                        Location: <b className="pl-2">{guruji.address}</b>
                      </h6>
                      <h6 className="pb-2">
                        Registered:{" "}
                        <b className="pl-2">
                      ...
                      {user.role === "USER" &&
                        user.guruji_subscribed_to === guruji.id && (
                          <h6 className="pb-2">
                            Calendly:{" "}
                            <b className="pl-2">
                              <a
                                href={`${guruji.calendly_link}`}
                                target="_blank"
                                rel="noreferrer"
                              >
                                {guruji.calendly_link}
                              </a>
                            </b>
                          </h6>
                        )}
                    ...
                    <div className="col-md-3">
                      {user.role === "ADMIN" && (
                        <h6 className="pb-2">
                          Earning: <b className="pl-2">${guruji.earning}</b>
                        </h6>
                      )}
                    </div>
                    ...
                    <div className="col-md-3">
                      <h6 className="pb-2">
                        Subscribers:{" "}
                        <b className="pl-2">{guruji.subscribers.length}</b>
                      </h6>
                      {user.role === "ADMIN" && (
                      ...
                      {user.role === "USER" &&
                        user.guruji_subscribed_to !== null && (
                          <a
                            href={
                              guruji.personal_store !== null
                                ? `${guruji.personal_store}`
                                : "#!"
                            }
                    ...
                    <div className="col-md-3">
                      {user.role === "ADMIN" && (
                        <a href="#!" className="btn btn-secondary px-3 py-2">
                          <b>BLACKLIST GURUJI</b>
                        </a>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row pl-4 none">
                    <div className="col-6 pb-3">
                      <h4>{guruji.name}</h4>
                      <p className="pb-2">
                        Subscribers: <b className="pl-2">23</b>
                      </p>
                    </div>
                    <div className="col-6 pb-3">
                      {user.role === "ADMIN" && (
                  ...
                  <h3 className="pl-4 none pb-3" style={{ color: "#211552" }}>
                    <b>Contents</b>
                  </h3>

                  <div className=" row mr-5 display_none align-items-center">
                    <div className="col-md-8 mt-2">
                      <h3 className="pl-4" style={{ color: "#211552" }}>
                        <b>Contents</b>
                      </h3>
                    </div>
                  ...
                  <div className="row mr-3 pl-4 mb-5 mt-3">
                    {guruji.contents.length > 0 &&
                      guruji.contents.map((content) => (
                        <Content
                          key={content.id}
