                            ...
                            <div className="contents">
                                <div style={{ marginTop: "10rem" }} className="mt">
                                    ...
                                    <div className="row mr-3 pl-4">
                                        {user.role === 'GURUJI' && 
                                            user.contents.length > 0 && user.contents.map((content) => (
                                    ...
                                    <div className="w-100 text-center">
                                        {user.role === 'GURUJI' &&
                                            <button type="button" onClick={toggleModal} className="btn mb-3" style={{ background: "linear-gradient(to right,#6561ba,#16168e)", border: "none", padding: ".8rem 3rem", color: "#fff" }}>
                                                <b>UPLOAD VIDEO</b>
                                            </button>
                                        }
                                    </div>
