          ...
          <div className="px-6 lg:pr-16 text-black">
            ...
            <div className="mt-10">
              ...
              <ul className="ml-8 text-xl list-disc font-semibold">
                ...
                <li>
                  1 on 1 virtual prayer session/special service bookings
                  (virtual prayers with a priest or church assistants lighting
                  candles for customers through online video streaming, or
                  having personal items blessed by a priest).
                </li>
              </ul>
